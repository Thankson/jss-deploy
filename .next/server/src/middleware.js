...
var _addPathPrefix = __webpack_require__(557);

var _pathHasPrefix = __webpack_require__(230);
...
var _removeTrailingSlash = __webpack_require__(622);

var _addPathPrefix = __webpack_require__(557);

var _addPathSuffix = __webpack_require__(560);

var _addLocale = __webpack_require__(576);
...
var _normalizeLocalePath = __webpack_require__(197);

var _removePathPrefix = __webpack_require__(624);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "default": () => (/* binding */ src_middleware)
});
...
async function middleware(req, ev) {
  ...
  return Object.values(middleware_plugins_namespaceObject).sort((p1, p2) => p1.order - p2.order).reduce((p, plugin) => p.then(res => plugin.exec(req, res, ev)), Promise.resolve(response));
}
...
var _relativizeUrl = __webpack_require__(820);
...
var _detectDomainLocale = __webpack_require__(48);
var _formatNextPathnameInfo = __webpack_require__(352);
var _getHostname = __webpack_require__(397);
var _getNextPathnameInfo = __webpack_require__(559);
...
const serverExports = {
  ...
  userAgentFromString: (__webpack_require__(538)/* .userAgentFromString */ .Nf),
  userAgent: (__webpack_require__(538)/* .userAgent */ .WE),
}
